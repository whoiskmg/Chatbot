...
namespace chatbotv1
{
    public partial class mezuniyetbelgesiform : Form
    {
        public mezuniyetbelgesiform()
        {
            InitializeComponent();
        }
        ...
        private void mezuniyetbelgesiform_Click(object sender, EventArgs e)
        {
        }
        ...
        private void mezuniyetbelgesiform_Load(object sender, EventArgs e)
        {

        }

        private void btngeri_Paint(object sender, PaintEventArgs e)
        {
